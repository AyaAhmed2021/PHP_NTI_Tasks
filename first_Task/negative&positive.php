...
if (isset($num)) {
    if ($num > 0) {
        echo   '<div class= "w-25 bg-warning text-center m-auto mt-3 p-3 fw-bold border border-rounded" >' . $num . " is a Positive number "  . '</div>';
    } else {
        echo   '<div class= "w-25 bg-warning text-center m-auto mt-3 p-3 fw-bold border border-rounded" >' . $num .  " is a Negative number" . '</div>';
    }
}
?>